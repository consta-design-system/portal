> Это инструкция по созданию и автоматической генерации иконок из SVG. Если вам нужно добавить иконку в Figma, загляните в [эту инструкцию](##LIBS.LIB.STAND.TAB/lib:portal/stand:custom-addicons/tab:design)
